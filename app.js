...
async function loadTexture (onProgress) {
  return new Promise(function loadTexturePromise (resolve, reject) {
    new three.TextureLoader().load(mangoTexture, resolve, onProgress, reject)
  })
}
